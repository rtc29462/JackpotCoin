...
public:
    ...
    uint256 GetHash() const
    {
        return HashSHA3(BEGIN(nVersion), nOption);
    }
...
public:
    ...
    void print() const
    {
        printf("CBlock(hash=%s, ver=%d, hashPrevBlock=%s, hashMerkleRoot=%s, nTime=%u, nBits=%08x, nNonce=%u, nPoWHeight=%u, nOption=%08x, nPoSHeight=%u, nPosPot=%u, vtx=%"PRIszu", vchBlockSig=%s)\n",
            GetHash().ToString().c_str(),
            nVersion,
            hashPrevBlock.ToString().c_str(),
            hashMerkleRoot.ToString().c_str(),
            nTime, nBits, nNonce, nPoWHeight, nOption, nPoSHeight, nPoSPot,
            vtx.size(),
    ...
    bool ConnectBlock(CValidationState &state, CBlockIndex *pindex, CCoinsViewCache &coins, bool fJustCheck = false, bool fCheckInput = true);
...
public:
    ...
    CBlockHeader GetBlockHeader() const
    {
        ...
        block.nBits				= nBits;
        block.nNonce			= nNonce;
		block.nPoWHeight		= nPoWHeight;
        block.nOption           = nOption;
        block.nPoSHeight        = nPoSHeight;
        block.nPoSPot           = nPoSPot;
        return block;
    }
