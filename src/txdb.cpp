    ...
    while (pcursor->Valid()) {
        ...
        try {
            ...
            if (chType == 'b') {
                ...
                pindexNew->nOption          = diskindex.nOption;
                pindexNew->nPoSHeight       = diskindex.nPoSHeight;
                pindexNew->nPoSPot          = diskindex.nPoSPot;
                ...
                if (!pindexNew->CheckIndex())
                    return error("LoadBlockIndexGuts() : CheckIndex failed at %d, %s", pindexNew->nHeight, pindexNew->ToString().c_str());
