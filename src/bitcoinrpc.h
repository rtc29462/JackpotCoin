...
extern json_spirit::Value getnostake(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value setnostake(const json_spirit::Array& params, bool fHelp);
