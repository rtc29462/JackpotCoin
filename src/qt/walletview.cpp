...
//    jackpotPage = new JackpotPage(gui);

//    explorerPage = new ExplorerPage(gui);
...
//      jackpotPage->setClientModel(clientModel);
//      explorPage->setClientModel(clientModel);
...
//      jackpotPage->setWalletModel(walletModel);
//      explorPage->setWalletModel(walletModel);
...
void WalletView::gotoJackpotPage()
{
//    gui->getJackpotAction()->setChecked(true);
//    setCurrentWidget(jackpotPage);
}
...
void WalletView::unlockWallet()
{
    ...
    else if (walletModel->getEncryptionStatus() == WalletModel::Unlocked && fWalletUnlockMintOnly)
    {
