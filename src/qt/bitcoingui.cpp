...
{
    resize(850, 550);
    setWindowTitle(tr("JackpotCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a JackpotCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About JackpotCoin"), this);
    aboutAction->setStatusTip(tr("Show information about JackpotCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for JackpotCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your JackpotCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified JackPotCoin addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if (clientModel)
    {
        ...
        updateMintingIcon();
        connect(clientModel, SIGNAL(timerEvent()), this, SLOT(updateMintingIcon()));

        // Add timer to update minting weights
        updateMintingWeights();
        connect(clientModel, SIGNAL(timerEvent_slow()), this, SLOT(updateMintingWeights()));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("JackpotCoin client"));
...
void BitcoinGUI::gotoJackpotPage()
{
    if (walletFrame) walletFrame->gotoJackpotPage();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to JackpotCoin network", "", count));
}
...
{
    QString strTitle = tr("JackpotCoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if (event->mimeData()->hasUrls())
    {
        ...
        else
        {
            if (!clientModel->getOptionsModel()->getHideNotification())
            {
                message(tr("URI handling"),tr("URI can not be parsed! This can be caused by an invalid JackpotCoin address or malformed URI parameters."),
...
void BitcoinGUI::updateMintingIcon()
{
    ...
    if (nLastCoinStakeSearchInterval && nWeight)
    {
        ...
        unsigned int nEstimateTime = nStakeTargetSpacing * nNetworkWeight / nWeight;
    ...
    else
    {
        ...
        {
            labelMintingIcon->setToolTip(tr("Not minting becasue wallet is locked"));
        }
