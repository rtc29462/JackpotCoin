...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a JackpotCoin address"));
    ...
    aboutAction->setToolTip(tr("Show information about JackpotCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for JackpotCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if (clientModel)
    {
        ...
        if (clientModel->isTestNet())
        {
            ...
            if (trayIcon)
            {
                trayIcon->setToolTip(tr("JackpotCoin client") + QString(" ") + tr("[testnet]"));
...
{
    jackpotAction->setChecked(true);
    centralWidget->setCurrentWidget(jacpotPage);
    exportAction->setEnabled(false);
    disconnect(exportAction, SIGNAL(triggered()), 0, 0);
}
*/
    ...
    if (walletModel)
    {
        ...
        if ((walletModel->getEncryptionStatus() == WalletModel::Locked) || fWalletUnlockMintOnly)
        {
            AskPassphraseDialog::Mode mode = sender() == unlockWalletAction ?
                  AskPassphraseDialog::UnlockMint : AskPassphraseDialog::Unlock;
...
void BitcoinGUI::lockWallet()
{
    ...
    { 
        ...
        {
            AskPassphraseDialog::Mode mode = AskPassphraseDialog::UnlockMint;
            AskPassphraseDialog dlg(mode, this);
            dlg.setModel(walletModel);
            dlg.exec();
        }
